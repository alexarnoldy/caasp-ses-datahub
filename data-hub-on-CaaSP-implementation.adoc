...
scp 172.16.200.130:/etc/ceph/ceph.conf /etc/ceph/
scp 172.16.200.130:/etc/ceph/ceph.client.data-hub-demo.keyring /etc/ceph/
scp /etc/ceph/ceph* master1:/etc/ceph/
for EE in 1 2 3; do scp /etc/ceph/ceph* worker$EE:/etc/ceph/; done
