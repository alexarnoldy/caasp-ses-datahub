#### CURRENT STATE OF THIS DOCUMENT: Lots of errors, needs to show how to do this with `yast lan` as it's much easier and persistent

* Description says that if VLANs are specifed on the host, the tags will be stripped off, before the packet is directed to that VLAN virtual interface
