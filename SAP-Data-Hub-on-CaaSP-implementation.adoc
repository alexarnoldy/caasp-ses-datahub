...
----
virsh pool-define-as ${CephPool}-${Host} dir - - - - /mnt/${CephPool}/${Host}
virsh pool-build ${CephPool}-${Host}
virsh pool-start ${CephPool}-${Host}
virsh pool-autostart ${CephPool}-${Host}
virsh pool-list --all
----
