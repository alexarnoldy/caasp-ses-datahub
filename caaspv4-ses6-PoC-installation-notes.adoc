...
** Go to `https://build.opensuse.org/package/show/Cloud:Tools/s3cmd`
** Click on the appropriate version of SLES/openSUSE in the column on the right 
** Click on the `Download` link for the "noarch.rpm" package
