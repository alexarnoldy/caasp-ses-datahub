...
#### Last updated: 2019.10.12, early AM PDT
...
* Select any partitioning scheme, but it is NOT RECOMMENDED to enable LVM 
...
** Set this variable to the Management Workstation's IP address (i.e. 172.16.200.130): MANAGEMENTIP=""
...
* On Boot Options line: `autoyast=http://ses-admin.stable.suse.lab:<nginx port>/ses-osd-c.xml ifcfg=eth0=<IP of master>/24,<IP of gateway>,<IP of DNS server>,stable.suse.lab hostname=ses-osd-c.stable.suse.lab`
